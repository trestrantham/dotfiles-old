...
###############################################################################
e_header "Dock and Dashboard"
###############################################################################

e_arrow "Enabling magnicfication"
defaults write com.apple.dock magnification -bool true

e_arrow "Setting magnication size"
...
e_arrow "Setting the icon size of Dock items to 36 pixels"
defaults write com.apple.dock tilesize -int 36

e_arrow "Minimize windows into their application’s icon"
defaults write com.apple.dock minimize-to-application -bool true

e_arrow "Enabling spring loading for all Dock items"
defaults write com.apple.dock enable-spring-load-actions-on-all-items -bool true

e_arrow "Showing indicator lights for open applications in the Dock"
defaults write com.apple.dock show-process-indicators -bool true

e_arrow "Setting Dock app icons"
